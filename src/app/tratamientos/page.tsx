    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-3xl p-8 text-center shadow-sm border border-gray-100">
                ...
                <h1 className="text-2xl font-black text-gray-900 mb-2">Tratamientos</h1>
                <p className="text-gray-500 mb-8">
                    Estamos trabajando en esta sección para mostrarte todos nuestros tratamientos disponibles.
                    <br />
                    <span className="text-sm font-bold text-gray-400 block mt-2">¡Próximamente!</span>
                </p>
