                        ...
                        <form onSubmit={handleSend} className="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent resize-none h-32 text-gray-900 font-medium"
                                    required
                                />
                            </div>
                                ...
                                <div className="animate-in fade-in slide-in-from-top-2 duration-300 relative">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent text-gray-900 font-bold"
                                            ...
                                            {filteredClients.length > 0 ? (
                                                filteredClients.slice(0, 10).map((client) => (
                                                    ...
                                                    >
                                                        ...
                                                        <div className="text-xs text-gray-600 font-medium">{client.email}</div>
                                                    </button>
                                                ))
                                            ) : (
                                            ...
                                            <div className="flex justify-between items-start mb-2">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-xs text-gray-400">
                                                        {item.sentAt instanceof Date ? item.sentAt.toLocaleString() : 'Recién enviado'}
                                                    </span>
                                                </div>
                                                <button
